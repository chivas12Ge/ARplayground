        ...
        ? React__default['default'].createElement(
          ...
          items.map(function (ref) {
            ...
            return React__default['default'].createElement(
              ...
              React__default['default'].createElement(HtmlOverlayContent, {html: html})
            )
          })
        )
        : null
    ...
    Stats.prototype.render = function render () {
      ...
      return (
        React__default['default'].createElement(
          'div',
          {style: style},
          Object.keys(stats).sort().map(function (key) { return React__default['default'].createElement('div', {key: key}, (key + ": " + (stats[key]))); }
          )
        )
      )
    };
